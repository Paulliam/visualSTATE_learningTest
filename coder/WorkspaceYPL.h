...
{
  VS_UINT8   transIndexIndex[13];
  VS_UINT8   transIndex[23];
  VS_UINT8   trans[79];
  VS_UINT8   machineInitDestState[8];
  VS_UINT8   machineInitTrans[8];
  VS_UINT8   firstMachine[8];
  VS_UINT8   machineParentStates[8];
  VS_UINT8   stateParentMachines[22];
};
...
{
  VS_UINT8   currentState[8];
  VS_UINT8   activeMachineBits[1];
  VS_UINT8   workingState[8];
